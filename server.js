...
2. 拓展闡述的句子須同時符合以下條件，才用【拓展】和【/拓展】標記包住：
   - 必須根植於題目情境：以資料一的活動細項或資料二的意見為出發點，符合文體、寫作身份及寫作對象
   - 必須超出資料字面內容：進一步引申其深層意義、對人的影響或長遠效果，而非重述資料已說明的事實
   - 不可脫離資料憑空發揮：引申必須與計劃目的、活動內容、同學處境有直接關聯
   正確例子：「靜觀練習坊」教導呼吸和放鬆技巧。【拓展】長期練習能幫助同學在考試或日常壓力下保持冷靜，將放鬆技巧內化為應對逆境的能力，而非一時的減壓方法。【/拓展】
   錯誤例子（不應標示）：「靜觀練習坊」將教導同學呼吸和放鬆技巧，有效減輕壓力和焦慮。（這是資料一的原有內容，屬引用而非拓展）
...
- 拓展闡述句子用【拓展】和【/拓展】標記包住
  拓展必須同時符合：
  ① 根植於題目情境（活動細項、同學疑慮、寫作身份）
  ② 超出資料字面內容（引申深層意義、對人的影響、長遠效果）
  ③ 不重述資料已說明的事實（引用資料不算拓展）
  每段正文中，引用資料部分不標示，只在真正引申的句子加標記
